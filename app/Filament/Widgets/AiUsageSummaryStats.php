...
class AiUsageSummaryStats extends StatsOverviewWidget
{
    ...
    protected function getStats(): array
    {
        ...
        return [
            ...
            Stat::make('Total Requests', number_format($totalRequests))
                ...
                ->color('primary'),
            Stat::make('Total Tokens', AiUsage::formatTokens($totalTokens))
                ->description('Avg '.number_format($avgTokens).' tokens/request')
                ->color('success'),
        ];
    }
}
