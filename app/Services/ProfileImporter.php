...
class ProfileImporter
{
    ...
    protected function validate(array $data): array
    {
        return Validator::make($data, [
            ...
            'profile.education.*.qualification' => ['required', 'string', 'max:300'],
            'profile.education.*.institution' => ['required', 'string', 'max:300'],
            'profile.education.*.field_of_study' => ['nullable', 'string', 'max:300'],
            'profile.education.*.period' => ['nullable', 'string', 'max:100'],
            'profile.education.*.highlights' => ['nullable', 'array'],
            'profile.education.*.highlights.*' => ['string', 'max:500'],
